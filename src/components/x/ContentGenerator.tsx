  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <label htmlFor="ica" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label htmlFor="userProfileBio" className="block text-sm font-medium text-gray-700 mb-1">
            Your Profile Bio
          </label>
          <textarea
        ...
        <div>
          <label htmlFor="trendingTopic" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="maxPostsToAnalyze" className="block text-sm font-medium text-gray-700 mb-1">
              Posts to Analyze
            </label>
            <input
        ...
        <div className="mt-8 p-6 bg-gray-50 rounded-lg">
          ...
          <div className="bg-white p-4 rounded border">
            <div className="text-sm text-gray-500 mb-2">
              Generated for {generatedContent.platform} • {generatedContent.contentType} • {new Date(generatedContent.generatedAt).toLocaleString()}
            </div>
